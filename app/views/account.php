          ...
          <div class="avatar">
            <form action="index.php?route=uploadAvatar" method="POST" enctype="multipart/form-data">
              <label for="avatar-upload" class="avatar-wrapper">
                <img 
                  src="<?= isset($_SESSION['avatar']) ? $_SESSION['avatar'] : 'public/assets/images/avatar-placeholder.png' ?>" 
                  alt="Avatar utilisateur" 
                  class="avatar-image"
                />
                <div class="edit-avatar-wrapper">
                  <a href="#" class="edit-avatar" onclick="document.getElementById('avatar-upload').click(); return false;">
                    modifier
                  </a>
                </div>
              </label>
